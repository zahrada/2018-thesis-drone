...
%% Abstrakt
\abstrakt {Tato diplomová práce se zabývá konstrukcí bezpilotního letadla pro geodetické účely na platformě Arduino s Arduino periferiemi.}  {This thesis describes construction of unmanned uerial vehicle for surveying jobs using Arduino platform and Arduino moduls.}
