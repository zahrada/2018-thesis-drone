...
public class BlueActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activi_blue);

        Button blueButton = (Button) findViewById(R.id.backButtonBlue);
        ...
        btnStartConnection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startConnection();
                Toast.makeText(BlueActivity.this,"Connected with" + mBTDevice.getName(), Toast.LENGTH_SHORT).show();
...
//***remember the conncction will fail and app will crash if you haven't paired first
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            mBluetoothConnection = new BluetoothConnectionService(BlueActivity.this);
        }
    }
}
