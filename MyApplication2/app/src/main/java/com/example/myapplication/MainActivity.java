...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInfo.setText("Turn on Bluetooth for show paired devices");
...
*/
            ...
            if(simpleSwitch.isChecked()){
                 intent = new Intent(MainActivity.this,AutonomControl.class);
            }
            else{
                intent = new Intent(MainActivity.this,ManualControl.class);
            }
